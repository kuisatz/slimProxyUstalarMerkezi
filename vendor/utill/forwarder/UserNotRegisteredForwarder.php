 ...
 */
class UserNotRegisteredForwarder extends \vendor\utill\forwarder\AbstractForwarder {
    ...
    public  function redirect() {
        ...
        $ch = curl_init('http://localhost/slim_Redirect_UstalarMerkezi/index.php/userNotRegistered');
